...
class HECKTORDataModule(LightningDataModule):
    ...
    def __init__(
        ...
        self.train_transforms = transforms.Compose([
            ...
            Mirroring(),
                # RandomRotation(),
              #  ExtractPatch((120, 120, 64)),
            #AdjustContrastCT(2.0),
                    #     ElasticDeformation(),
            ToTensor(),
                   # Zoom(0.7),
        ])
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        # df = pd.read_csv('/data/datasets/TMSS_EC_Sorted/EC.csv')
        ...
        train_dataset, val_dataset = Subset(self.dataset, train_idx[self.Fold]), Subset(self.dataset,
                                                                                        test_idx[self.Fold])

...
class UMambaEnc(nn.Module):
    ...
    def forward(self, x):
        # print("umamba_enc ", x.shape) # [2, 1, 40, 224, 192]
        skips = self.encoder(x)
        # decoder1 # [2, 14, 40, 224, 192]
        # decoder2 # [2, 14, 40, 112, 96]
        # decoder3 # [2, 14, 20, 56, 48]
        # decoder4 # [2, 14, 10, 28, 24]
        # decoder5 # [2, 14, 5, 14, 12]
